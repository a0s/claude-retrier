...
| `CR_NOTIFY_REPEAT_SEC` | `300` | how often an `unfold failed` or `restart off` debt is said again, until a key is pressed; see [how-it-works.md](how-it-works.md#a-sign-of-life) |
